/**
 * 与 frontend/src/utils/chartAdapter.js 保持同步 · ChartSpec → ECharts option
 */
...
function buildEchartsOption({ chartSpec, columns, rows }) {
...
module.exports = { buildEchartsOption, CHART_COLORS }
