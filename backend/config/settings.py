...
class Settings(BaseSettings):
    ...
    recall_top_k_table: int = Field(default=8, alias="RECALL_TOP_K_TABLE")
    recall_top_k_column: int = Field(default=5, alias="RECALL_TOP_K_COLUMN")
    recall_top_k_metric: int = Field(default=5, alias="RECALL_TOP_K_METRIC")
    recall_top_k_value: int = Field(default=5, alias="RECALL_TOP_K_VALUE")
    max_tables_in_prompt: int = Field(default=8, alias="MAX_TABLES_IN_PROMPT")
