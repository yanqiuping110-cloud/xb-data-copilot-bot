...
> **关联文档**：[01-MVP_DEVELOPMENT_PLAN.md](./01-MVP_DEVELOPMENT_PLAN.md) §11.5（会话记忆）、[13-ASK_STREAM_UI_PLAN.md](./13-ASK_STREAM_UI_PLAN.md)、[92-EVAL_QUESTIONS.md](./92-EVAL_QUESTIONS.md)、[eval/dialogue_gate.json](./eval/dialogue_gate.json)  
